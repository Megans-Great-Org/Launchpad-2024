...
const weatherConditions = [
  ...
  },
  {
    ...
    image: 'assets/partly-clouds.jpeg',
    colour: '#52BBE8',
  },
  {
    code: 2,
  ...
  },
  {
    ...
    image: 'assets/thunder-storm.jpeg',
    colour: '#194356',
  },
  {
    code: 9,
...
function getWeatherData(city) {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      weather[0].innerText =
        weatherConditions[data.current.weather_code].condition;
      ...
      weatherCircle[0].style.backgroundColor =
        weatherConditions[data.current.weather_code].colour;
